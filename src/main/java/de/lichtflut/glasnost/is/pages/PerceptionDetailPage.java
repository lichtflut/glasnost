 ...
 * @author Ravi Knox
 */
public class PerceptionDetailPage extends RBBasePage {
	 ...
	 */
	public PerceptionDetailPage(final PageParameters parameters){
		super(parameters);
	 ...
	 */
	public PerceptionDetailPage(final IModel<Perception> model, final Model<DisplayMode> displayMode) {
